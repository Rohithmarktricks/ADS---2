...
public class TestAnalysis {
	...
	public static int binSteps1 = 0;
	public static int seqSteps2 = 0;
	public static int binSteps2 = 0;
	public static int seqSteps3 = 0;
	public static int binSteps3 = 0;
	public static int minBinarySteps = 0;
	public static int maxBinarySteps = 0;
	public static int minSeqSteps = 0;
	public static int maxSeqSteps = 0;
	public TestAnalysis() {
		//unused.
	}

	public static void main(String[] args) {
		new TestAnalysis().doIT(limit);
	}
	public static void doIT(int limit) {
		...
		for (int j = 0 ; j < 50; j++) {
			...
			Integer tempResult = st.get(target*1000);
