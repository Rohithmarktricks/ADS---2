// package chapter3_searching.C3_2_BinarySearchSTs;
...
/**
 * The {@code BinarySearchST} class represents an ordered symbol table of generic
 * key-value pairs.
...
public class BinarySearchST<K extends Comparable<K>, V> {
     ...
     * Gets the bin steps.
     *
     * @return     The bin steps.
     */
    public int getBinSteps() {
        return steps;
    }
    ...
    public double timeBinary(int i) {
        return ((double) log(i, 2));
    }
    ...
    //     BinarySearchST<String, Integer> tree = new BinarySearchST<String, Integer>();
    //     int count = 0;
